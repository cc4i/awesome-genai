...
# Handle imports for both running from project root and from analysis directory
try:
    from apps.analysis.utiles.playbook_tools import PlaybookTools
    from apps.analysis.utiles.sentiment import Sentiment
except ImportError:
    # Fallback for running from analysis directory
