...
# Handle imports for both running from project root and from console directory
try:
    from apps.console.c_utils import promot_template_4_twitter, promot_template_4_google
    from apps.console.c_utils import call_llm_sdk
    from apps.console.c_utils import x_thread_by_id
    from apps.console.c_utils import semtiment_score_by
    from apps.console.c_utils import sentiment_level_by
    from apps.console.c_utils import sentiment_distribution_by
    from apps.console.c_utils import x_threads
    from apps.console.c_utils import last_playbook
    from apps.console.c_utils import generate_playbook
    from apps.console.c_utils import x_add_thread
    from apps.console.c_utils import x_update_thread
    from apps.console.c_utils import x_delete_thread
    from apps.console.c_utils import x_posts
except ImportError:
    # Fallback for running from console directory
