...
class Post():
    def __init__(self, engine: sqlalchemy.engine.Engine, table_name="posts"):
        ...
        self.table = Table(
            ...
            """),
            Column("conent_type", String, nullable=False, comment="""
                The content type is indicated for original content, which is one of these: post, comment, or page.
            """),
            Column("user_id", String, comment="""
                The indentifier of user. who created or posted the content in media platform.
            """),
            Column("hastags", ARRAY(String), comment="""
                The hashtag is a list of strings, which are scraped from the original post, such as "#hashtag1", "#hashtag2", etc.  
            """),
            Column("likes", Integer, comment="""
                The total number of likes.
            """),
            Column("shares", Integer, comment="""
                The total number of this content is shared.
            """),
            Column("comments", Integer, comment="""
                The total number of this content has.
            """),
            Column("sentiment_score", Double, comment="""
                The sentiment score is back from sentiment analysis and value is between -1 and 1.
            """),
            Column("sentiment_magnitude", Double, comment="""
                The sentiment magnitude indicates the overall strength of emotion (both positive and negative) within the given text, between 0.0 and +inf.
            """),
            Column("sentiment_label", String, comment="""
                The sentiment lable includes positive(score > 0), neutral(score = 0), negative(score < 0).
            """),
            ...
            """),
            Column("scraped_at", TIMESTAMP, nullable=False, comment="""
                When this record has been scraped from internet.
            """),
            Column("sentiment_at", TIMESTAMP, comment="""
                When update the sentiment result to this record .
            """),
            Column("generated_at", TIMESTAMP, comment="""
                When genertate the engagement content for this record.
            """),
